...
- Step 1: heading "Choose how you want to practice." + 4 option cards (1:1, Orgs & Teams, Group, Self-led). **× close → `/`** top-right (`.bf-step1-nav` > `.bf-close`, hover → `--blue`) — gives a way out of the flow's first step, matching Step 2's × (Step 1 has no "back" since it's first).
