...
- Step 1: eyebrow "— · Begin your practice" + heading "Choose how you want to practice." + 4 option cards (1:1, Orgs & Teams, Group, Self-led)
  ...
  - **Step padding (mobile):** Step 1 stays tight (`padding-top: 20px`, header margin 12px) for the one-viewport fit; **Steps 2 & 3 use the 72px mobile section top** (Step 3 via the base `.bf-step__inner`, Step 2 explicitly).
