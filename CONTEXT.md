...
- Body font-size — `+0.020em` tracking, `24px`/`26px` line-height. Two groups (Ben-approved 2026-06-02, commit c98f2ce):
  - **16px desktop / 16px mobile:** S2 card desc (`.s2__card-desc`, line-height 24px), S5 paragraphs (`.s5__para` non-first), S6 bio (`.s6__para`)
  - **14px desktop / 16px mobile:** S7 answers (`.s7__answer-inner`), form fields, contact-form body (`.s-contact__body`)
