...
_Last updated: 2026-06-11 (**session 8 — OPEN**). **Handoff 7: mobile menu shipped (committed locally, NOT yet pushed).** Rollback: tag `pre-handoff-7` = `1b0215f` (on origin). Session 8 so far:_
...
| — | **Mobile menu** (`Nav.astro` `.mmenu*`) | ✅ Complete — **local only, not pushed** (2026-06-11, handoff 7; design.md §5.15; ≤640px ink curtain) |
